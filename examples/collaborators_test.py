...
async def main():
    ...
    print(
        f"Fetching collaborator information for {len(repo_urls)} repositories...")
    try:
        collaborators = await provider.fetch_collaborators(repo_urls)
